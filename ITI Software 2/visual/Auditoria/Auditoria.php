                    ...
                    <div class="container-fluid">
                        ...
                        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                            <ul class="nav navbar-nav ml-auto">
                                <?php if($rolsesion == "Subdirección B" || $rolsesion == "Auditoría" || $rolsesion == "Informática" || $rolsesion == "Administrador"){ ?>
                                ...
                                <?php } ?>
                                <?php if($rolsesion == "Auditoría" || $rolsesion == "Informática" || $rolsesion == "Administrador"){ ?>
